    ...
    var LiteAccordion = function(elem, options) {
        ...
        // core utility and animation methods
            core = {
                ...
                setStyles : function() {
					headerText.innerHTML = settings.leftText;
				
                    // set container height and width, theme and corner style
                    elem
                        .width(settings.containerWidth - settings.headerWidth)
                ...
                setSlidePositions : function() {
                    ...
                    header.each(function(index) {
                        ...
                        $this
                            .css('left', (left - index * settings.headerWidth))
                            .width(settings.containerHeight)
                            .next()
                                .width(slideWidth - offset)
                                .css({ left : (left - index * settings.headerWidth), paddingLeft : index * settings.headerWidth });
                ...
                animSlide : function(triggerTab) {
                    ...
                    if (!!this.index) {
						//set Advanced/Basic slide text
						headerText.innerHTML = (headerText.innerHTML === settings.leftText) ? settings.rightText : settings.leftText;
